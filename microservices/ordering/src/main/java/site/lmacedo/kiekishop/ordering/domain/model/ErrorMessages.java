...
public class ErrorMessages {
    ...
    public static final String VALIDATION_ERROR_LOYALTYPOINTS_IS_NEGATIVE = "LoyaltyPoints cannot be negative";
    ...
    public static final String ERROR_ORDER_DOES_NOT_CONTAINS_ITEM = "Order %s does not contains item %s";

    public static final String ERROR_PRODUCT_IS_OUT_OF_STOCK = "Product %s is out of stock";


    public static final String ERROR_SHOPPING_CART_DOES_NOT_CONTAINS_ITEM = "Shopping Cart %s does not contain item %s";

    public static final String ERROR_SHOPPING_CART_DOES_NOT_CONTAINS_PRODUCT = "Shopping Cart %s does not contain product %s";
